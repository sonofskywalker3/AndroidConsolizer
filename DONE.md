...
- **NOT yet done (before v4.0.0 release):** the stuck #76 tool-hit box (revert to facing on fade), #77 settings persistence (zoom + tool-hit box across cold restart), and pre-release hygiene (demote remaining diagnostics, consider removing the now-redundant `EnforceTick`). See `docs/superpowers/specs/2026-06-05-handoff-right-stick-cursor-wip.md`.
