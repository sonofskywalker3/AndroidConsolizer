...
- **NOT yet done (before v4.0.0 release):** pre-release hygiene only — demote remaining verbose diagnostics (`[BtnMap]`/`[ToolIdx]`/`[SPDiag]`), consider removing the now-redundant `EnforceTick`. (#79, #76, #77 all done — below.) See `docs/superpowers/specs/2026-06-05-handoff-right-stick-cursor-wip.md`.
