...
### 75. Shop Buy-List Jumps To Top On Purchase — 🔧 FIX-ATTEMPT v3.8.22, awaiting device test
...
- **Still to verify on device:** list stays put across a purchase; buying out a stack re-selects the next item AND keeps it on-screen. Confirmed it does scroll in the Cart Catalog (Traveler) shop.
