...
**Current version:** **3.7.75** (committed locally). **Last GitHub release: v3.7.0** (2026-05-14). **Everything from v3.7.1 → v3.7.75 is committed locally but NOT pushed** — a publish is owed whenever the user gives the explicit go-ahead (push + GitHub release + README + Nexus). **v3.8.0 is now content-complete (#27 + #47 were the last two items) → a publish is owed.**

**Session 2026-05-31 — #27 toolbar size slider DONE + #47 missed-rewards chest NOT-A-BUG (both device-verified G Cloud, v3.8.0 content-complete):**
...
- **Next: the v3.8.0 publish is owed** (push to GitHub + release + README + Nexus) on the user's explicit go-ahead. Nothing v3.7.1→v3.7.75 is pushed yet.
